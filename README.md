...
Small Python daemon for DBus `org.freedesktop.Notifications`, which emits each notification event as newline-delimited JSON.

Intended for use with status bar software like [Eww](https://github.com/elkowar/eww).
